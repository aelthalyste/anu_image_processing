...
set debug_build_flags=-O0 -fsanitize=address -g -fsanitize=address -fno-inline-functions -D"BG_DEVELOPER=1"
set release_build_flags=-O3 -D"BG_DEVELOPER=0" -g

:: default build type is debug
set build_flags=%common_flags% %release_build_flags%
